                    ...
                    <div class="row">
                        <div class="col-md-8 ov-h">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="widget">
                                        <h6 class="upper text-right">ABOUT MINIINC</h6>
                                            <p style="text-align: right;"><?= $contact['contact_office'] ?><br/>
                                ...
                                <div class="col-md-12">
                                    <div class="widget">
                                        ...
                                        <div class="footer-newsletter">
                                            <form action="<?php echo base_url('subscribe/saveEmail') ?>" data-mailchimp="true" class="inline-form">
                                                <div class="input-group">
                                                    <input type="email" name="u_subscribe_email" placeholder="Your Email" class="form-control"><span class="input-group-btn"><button type="submit" data-loading-text="Loading..." class="btn btn-color">Subscribe</button></span>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
