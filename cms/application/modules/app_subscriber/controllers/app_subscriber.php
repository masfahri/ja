...
class App_subscriber extends MX_Controller {
    
    # property
    public $root;
    public $app_name            = ''; 
    public $pageTitle           = ''; 
    public $initialPage         = 'Email Subscribe';
    ...
    public function data(){
        ...
        $config['total_rows']   = $this->coredb->getTotalEmail();
        $config['per_page']     = 10; 
        $config['uri_segment']  = 3 ;
        $this->pagination->initialize($config);
        // result of page
        $params['result_all'] =  $config['total_rows'];
        $params['datadb'] =  $this->coredb->getAllEmail($config["per_page"], $this->uri->segment(3));
    ...
    public function download(){
        ...
        $params['datadb'] =  $this->coredb->getAllEmail();
