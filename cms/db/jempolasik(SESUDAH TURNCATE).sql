...
--
-- Host: localhost:3306
-- Generation Time: Jan 19, 2017 at 02:25 PM
...
(1, 99101112, 500, 'Jhon Doe', '55c3b5386c486feb662a0785f340938f518d547f', NULL, 'uploads/image/user/10172591_803930459618634_70630334860658070_n_170119125027.jpg'),
(2, 99101113, 501, 'Alphabet', '55c3b5386c486feb662a0785f340938f518d547f', NULL, 'uploads/image/user/Xanctum_galaxy_170119125057.jpg'),
(3, 99101114, 502, 'Bad Way', '55c3b5386c486feb662a0785f340938f518d547f', NULL, 'uploads/image/user/bg_170119125134.jpg');
...
(1, 'Mon', '1', 0, '03:00:00', '06:00:00', 'Masuk Kelas', 0, 'active'),
(2, 'Tue', '1', 0, '03:00:00', '06:00:00', 'Masuk', 0, 'active'),
(3, 'Wed', '1', 0, '03:00:00', '06:00:00', 'Masuk', 0, 'active'),
(4, 'Thu', '1', 0, '03:20:00', '03:30:00', '', 0, 'active'),
(5, 'Fri', '1', 0, '02:00:00', '05:00:00', 'Masuk', 0, 'active');
...
(1, 1, '1701000', 'KAMAL', '085883518288', 'BAPAK'),
(2, 1, '1701001', 'SAKIDI', '089651888834', 'Ibunya'),
(3, 1, '1701003', 'EKO', '08812110623', 'BAPAK'),
(4, 0, '1701004', 'FITRI', '081586555281', 'IBU'),
(5, 2, '1702000', 'KATMANI', '085693421216', 'BAPAK'),
(6, 2, '1702001', 'Bapak Aldi', '089627424351', 'BAPAK'),
(7, 0, '1703001', 'LUTFY', '085973962986', 'IBU'),
(8, 3, '1703002', 'DWI', '082213660240', 'IBU');
...
INSERT INTO `ja_siswa` (`id`, `nis`, `pin`, `nama_siswa`, `nama_panggilan`, `kelamin`, `tempat_lahir`, `tgl_lahir`, `agama`, `alamat`, `password`, `id_kelas`, `absen`, `foto`, `tahun_ajaran`) VALUES
(1, 1701000, 1, 'Muhammad Fakhrizal', 'Fakhri', 'L', 'Jakarta', '1997-01-06', 'Islam', 'Pondok Kacang Prima', '', 1, 1, 'uploads/image/user/10172591_803930459618634_70630334860658070_n_170119041058.jpg', ''),
(2, 1701001, 2, 'Dharmawan Budi Aji', 'Budi', 'L', 'Jakarta', '1994-12-25', 'Islam', 'Pondok Kacang Prima', '', 1, 2, NULL, ''),
(3, 1701003, 3, 'Farhan Alify', 'Farhan', 'L', 'Jakarta', '1995-03-24', 'Islam', 'Pondok Kacang Prima', '', 1, 3, NULL, ''),
(4, 1701004, 4, 'Arif tri Nugroho', 'Arif', 'L', 'Jakarta', '2016-12-27', 'Islam', 'Pondok Kacang Prima', '', 1, 4, NULL, ''),
(5, 1701005, 5, 'Markonah', 'Marko', 'P', 'Bantenan', '2017-01-19', 'Islam', 'Depan Komplek PKP', '', 1, 5, NULL, ''),
(6, 1702000, 6, 'Nanda Firmansyah', 'Nanda', 'L', 'Disono', '2017-01-19', 'Islam', 'Puri Bintaro Hijau', '', 2, 1, NULL, ''),
(7, 1702001, 7, 'Aldi Susanto', 'Adul', 'L', 'Jakarta', '2017-01-19', 'Islam', 'Puri Bintaro Hijau', '', 2, 2, NULL, ''),
(8, 1702002, 8, 'Rangga Defri', 'Gareng', 'L', 'Jogja', '2017-01-19', 'Islam', 'Puri Bintaro Hijau', '', 2, 3, NULL, ''),
(9, 1703000, 9, 'Harum Mawar', 'Mawar', 'L', 'Jakarta', '2017-01-19', 'Islam', 'Jauh disana', '', 3, 1, NULL, ''),
(10, 1703001, 10, 'Hesti Lutfyan', 'Hesti', 'P', 'Jakrta', '1996-10-31', 'Islam', 'Jurang Mangu', '', 3, 2, NULL, ''),
(11, 1703002, 11, 'Tasya Dwi Ayu Lestari', 'Tasya', 'P', 'Jakarta', '2017-01-03', 'Islam', 'Jakarta Utara', '', 3, 3, NULL, '');
...
--
ALTER TABLE `ja_jurusan`
  MODIFY `id_jurusan` int(111) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ja_karyawan`
--
ALTER TABLE `ja_karyawan`
  MODIFY `id_karyawan` int(222) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `ja_kelas`
  MODIFY `id_kelas` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
