...
--
-- Host: localhost:3306
-- Generation Time: Nov 17, 2016 at 09:16 PM
...
(2, 1, 40, '2016-11-15 23:30:13', '0000-00-00 00:00:00', 0, 0, '1'),
(3, 2, 40, '2016-11-15 23:47:54', '2016-11-15 00:00:00', 0, 0, '1');
...
(2, 1411501422, 2, 'Ucok', 'Hesti', 'P', 'Tangerang Selatan', '1996-10-30', 'Islam', 'Jurang Mangu Permai', 'hesticantik', 40, 2, NULL),
...
ALTER TABLE `ja_data_absen`
  ...
  ADD CONSTRAINT `ja_data_absen_ibfk_2` FOREIGN KEY (`id_kelas`) REFERENCES `ja_siswa` (`id_kelas`);
