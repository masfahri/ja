...
<section class="socmedwrapper" >
	<div class=" container" style="background:url('<?= config_item('assets_img') ?>home/slider.jpg')">
                ...
                foreach($gallery as $row){
                    ...
                    <div class="work-item">
                        <div class="work-detail">
                            ...
                            <img alt="'.$row['album_name'].'" src="'.base_url().'cms/'.$row['file'].'"/>
                        ...
                        <div class="work-detail">
                            ...
                            <div class="cat-info">Gallery</div>
                                <div class="work-info">
                                    <div class="centrize">
                                        <div class="v-center">
                                            <div class="fa fa-youtube-play fa-3x"></div>
                                            <h3>'.$title.'</h3>
                                            <p>'.$row['album_title'].'</p>
                                        </div>
                                    </div>
